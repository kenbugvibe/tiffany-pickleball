...
export const metadata: Metadata = {
  title: "Open-play registration received",
};
...
export default async function OpenPlayConfirmationPage({
  params,
}: {
        ...
        <section className="mt-5 overflow-hidden rounded-3xl bg-cream-50 shadow-[0_24px_70px_rgba(0,0,0,.3)]">
          <div className="bg-court-800 px-6 py-8 text-center text-white sm:px-10">
            ...
            <h1 className="mt-2 font-display text-4xl font-bold">
              {confirmed ? "You’re joining open play." : "Your place is reserved."}
            </h1>
            <p className="mt-3 text-sm leading-6 text-white/70">
              {confirmed
                ? "Tiffany verified your payment. You are confirmed for this session."
