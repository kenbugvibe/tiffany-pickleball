...
import { createSundayUnliSignupAction } from "@/actions/sunday-unli";
import { emptyBookingActionState } from "@/lib/booking-form-state";

export function SundayUnliJoinForm({
  sessionId,
  priceLabel,
  paymentConfigured,
}: {
  ...
  return (
    <form action={formAction}>
      ...
      >
        {pending ? "Creating payment hold…" : "Join Sunday Unli"}
      </button>
